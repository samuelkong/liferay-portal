...
PortalUtil.addPortletBreadcrumbEntry(request, LanguageUtil.get(request, "addresses"), PortalUtil.escapeRedirect(editContactInformationDisplayContext.getRedirect()));
