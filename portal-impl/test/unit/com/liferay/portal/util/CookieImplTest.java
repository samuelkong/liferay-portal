...
public class CookieImplTest {
	...
	public void testDomain() {
		...
		Assert.assertEquals(
			"192.168.0.1", _cookieImpl.getDomain("192.168.0.1"));

		Assert.assertNull(_cookieImpl.getDomain("com.cn"));

		Assert.assertEquals(
			".brisbane.qld.gov.au",
			_cookieImpl.getDomain("www.brisbane.qld.gov.au"));

		Assert.assertEquals(
			".cdn.brisbane.qld.gov.au",
			_cookieImpl.getDomain("www.cdn.brisbane.qld.gov.au"));

		Assert.assertNull(_cookieImpl.getDomain("test"));
