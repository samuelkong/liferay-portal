...
public class MBThreadServiceWrapper implements MBThreadService,
	...
	public java.util.List<com.liferay.portlet.messageboards.model.MBThread> getGroupThreads(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _mbThreadService.getGroupThreads(groupId, userId, categoryId,
	...
	public int getGroupThreadsCount(long groupId, long userId, long categoryId,
		int status, boolean subscribed, boolean includeAnonymous)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _mbThreadService.getGroupThreadsCount(groupId, userId,
			categoryId, status, subscribed, includeAnonymous);
	}
