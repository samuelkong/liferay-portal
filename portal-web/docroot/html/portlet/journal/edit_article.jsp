...
if ((article == null) && (Validator.isNull(defaultLanguageId) || !LanguageUtil.isAvailableLanguageCode(defaultLanguageId))) {
	...
	if (Validator.isNull(defaultLanguageId) || !LanguageUtil.isAvailableLanguageCode(defaultLanguageId)) {
