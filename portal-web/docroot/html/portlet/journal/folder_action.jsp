...
Object mergeWithParentFolderDisabledObj = request.getAttribute("view_entries.jsp-folderSelected");
			...
			<c:when test="<%= folder != null %>">
				<c:if test="<%= JournalFolderPermission.contains(permissionChecker, folder, ActionKeys.UPDATE) %>">
					<portlet:renderURL var="editURL">
						...
						<portlet:param name="mergeWithParentFolderDisabled" value="<%= String.valueOf(mergeWithParentFolderDisabledObj) %>" />
					</portlet:renderURL>
