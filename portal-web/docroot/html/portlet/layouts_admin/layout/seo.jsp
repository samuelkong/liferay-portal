...
<c:if test="<%= PortalUtil.isLayoutSitemapable(selLayout) %>">
	...
	<aui:fieldset>
		...
		<liferay-ui:error exception="<%= InvalidIncludeException.class %>" message="please-enter-a-valid-include" />
		...
		<liferay-ui:error exception="<%= InvalidPagePriorityException.class %>" message="please-enter-a-valid-page-priority" />
		...
		<liferay-ui:error exception="<%= InvalidChangeFrequencyException.class %>" message="please-enter-a-valid-change-frequency" />
