...
<aui:fieldset>
	...
	<aui:input cssClass="lfr-input-text-container" label="service-password" name='<%= "settings--" + PropsKeys.NTLM_SERVICE_PASSWORD + "--" %>' type="password" value="<%= Portal.TEMP_OBFUSCATION_VALUE %>" />
</aui:fieldset>