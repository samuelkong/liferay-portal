...
<c:choose>
	...
	<c:otherwise>
		...
		%>
				...
				<tr>
					<td>
						<a href="<%= rowURL.toString() %>"><img align="left" alt="" border="0" src="<%= HtmlUtil.escapeHREF(themeDisplay.getPathThemeImages()) %>/file_system/small/<%= fileEntry.getIcon() %>.png" /><%= fileEntry.getTitle() %></a>
					</td>
				</tr>
