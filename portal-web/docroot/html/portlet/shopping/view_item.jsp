	...
	<tr>
		...
		<td class="lfr-top">
			...
			%>
				...
				<aui:fieldset>
					<aui:select label="<%= HtmlUtil.escape(fieldName) %>" name='<%= "fieldName" + itemField.getItemFieldId() %>'>
...
<aui:script>
	function <portlet:namespace />addToCart() {
		...
		%>
			...
			if (document.<portlet:namespace />fm.<portlet:namespace />fieldName<%= itemField.getItemFieldId() %>.value == "") {
			...
			document.<portlet:namespace />fm.<portlet:namespace />fields.value =
				document.<portlet:namespace />fm.<portlet:namespace />fields.value
				+ '<%= HtmlUtil.escapeJS(fieldName) %>='
				+ document.<portlet:namespace />fm.<portlet:namespace />fieldName<%= itemField.getItemFieldId() %>.value
				+ '&';
