...
String dayParamId = HtmlUtil.toAuiCompatibleId(dayParam);
String monthParamId = HtmlUtil.toAuiCompatibleId(monthParam);
String nameId = HtmlUtil.toAuiCompatibleId(name);
String yearParamId = HtmlUtil.toAuiCompatibleId(yearParam);
%>
