...
String dayParamId = HtmlUtil.toWordCharacters(dayParam);
...
String monthParamId = HtmlUtil.toWordCharacters(monthParam);
...
String yearParamId = HtmlUtil.toWordCharacters(yearParam);
