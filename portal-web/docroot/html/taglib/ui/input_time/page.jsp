...
String amPmParamId = HtmlUtil.toWordCharacters(amPmParam);
...
String dateParamId = HtmlUtil.toWordCharacters(dateParam);
...
String hourParamId = HtmlUtil.toWordCharacters(hourParam);
...
String minuteParamId = HtmlUtil.toWordCharacters(minuteParam);
...
String nameId = HtmlUtil.toWordCharacters(name);
