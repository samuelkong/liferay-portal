...
String amPmParamId = HtmlUtil.toAuiCompatibleId(amPmParam);
String dateParamId = HtmlUtil.toAuiCompatibleId(dateParam);
String hourParamId = HtmlUtil.toAuiCompatibleId(hourParam);
String minuteParamId = HtmlUtil.toAuiCompatibleId(minuteParam);
String nameId = HtmlUtil.toAuiCompatibleId(name);
%>
