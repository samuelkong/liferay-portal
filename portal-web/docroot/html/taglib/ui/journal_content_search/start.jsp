...
<aui:input alt="search" cssClass="lfr-search-button" inlineField="<%= true %>" label="" name="search" src='<%= HtmlUtil.escapeHREF(themeDisplay.getPathThemeImages()) + "/common/search.png" %>' type="image" />