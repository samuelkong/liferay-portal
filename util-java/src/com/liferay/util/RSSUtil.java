...
public class RSSUtil {
	...
	public static String getFormatType(String format) {
		...
		if (StringUtil.contains(format, ATOM, StringPool.BLANK)) {
			formatType = RSSUtil.ATOM;
		}
		else if (StringUtil.contains(format, RSS, StringPool.BLANK)) {
	...
	public static double getFormatVersion(String format) {
		...
		if (StringUtil.contains(format, "10", StringPool.BLANK)) {
			formatVersion = 1.0;
		}
		else if (StringUtil.contains(format, "20", StringPool.BLANK)) {
			formatVersion = 2.0;
		}
