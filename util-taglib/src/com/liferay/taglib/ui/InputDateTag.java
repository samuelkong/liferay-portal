...
public class InputDateTag extends IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		...
		request.setAttribute(
			...
			HtmlUtil.toAttributeSafe(_dayParam));
		request.setAttribute(
